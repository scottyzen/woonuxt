    ...
    <CookieControl ref="cookiecontrol" v-if="loaded">
      <template v-slot:bar>
        <div class="right-8 bottom-8 left-8 z-10 fixed">
          ...
          >
            <div class="rounded-full bg-[#141d2a] p-0.5 -top-4 -left-4 text-orange-400 absolute md:static">
            ...
            <span class="font-light flex-1 z-10"
              ...
              with it.</span
            >
            <button class="border bg-[#141d2a] border-gray-700 rounded-2xl w-full p-2 md:w-auto md:p-3" @click="accept">
