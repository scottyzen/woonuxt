<template>
	<a @click="toggleWishlist" class="cursor-pointer flex mt-4 text-sm text-gray-400 gap-2 items-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18">
...
export default {
	...
	watch: {
		'$store.state.wishlist': function (newVal, oldVal) {
			this.isWishlisted = newVal.some((product) => {
				return product.databaseId === this.product.databaseId;
			});
		},
	},
};
