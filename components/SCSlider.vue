<template>
  <div class="gap-4 scslider-wrap" :class="{ container: containerFromLeft === 0 }">
    <div class="my-4 scslider relative" :style="cssVars" ref="scslider" @scroll="handleScroll($event)" :class="extraClass ? extraClass : ''">
      <slot />
    </div>
    <div class="container flex my-6 text-gray-500 gap-1 justify-end">
      <div class="cursor-pointer" :class="!hasPrev ? 'opacity-25 cursor-default' : ''" @click="prev">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 512 512">
          <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M328 112L184 256l144 144" />
        </svg>
      </div>
      <div class="cursor-pointer" :class="!hasNext ? 'opacity-25 cursor-default' : ''" @click="next">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 512 512">
