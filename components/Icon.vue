<template>
    <svg v-if="name == 'filter'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
    ...
    <svg v-else-if="name == 'back-arrow'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
            fill="none"
            stroke="currentColor"
            stroke-linecap="round"
