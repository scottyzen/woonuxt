<template>
	<button @click="triggerAddToCart" class="p-2 text-white bg-purple-500 rounded-2xl min-w-[150px] text-center">Add to Cart</button>
</template>
...
export default {
	props: ['productId', 'quantity', 'variation', 'disabled'],
	methods: {
