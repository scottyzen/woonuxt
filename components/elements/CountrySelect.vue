<template>
  <select :value="defaultValue" @change="select" class="shadow-none">
    <option def v-for="country in countries" :key="country.name" :value="country.countryCode">{{ country.countryName }}</option>
  </select>
</template>
