...
- Download the lates WooNuxt Settings (woonuxt-settings.zip) from the releases page here: [Releases]([WooNuxt Settings](https://github.com/scottyzen/woonuxt-settings/releases)
