...
- Download the [WooNuxt Settings](https://github.com/scottyzen/woonuxt-settings/releases/download/1.0.22/woonuxt-settings.zip) plugin.
...
> **Note** The the [WooNuxt Settings](https://github.com/scottyzen/woonuxt-settings/releases/download/1.0.22/woonuxt-settings.zip) plugin will help you install all the required plugins.
