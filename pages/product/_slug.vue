			...
			<div class="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
				...
				<div class="flex items-center pb-5 mt-6 mb-5 border-b-2 border-gray-100">
					<div class="flex">
						...
						<button class="w-6 h-6 border-2 border-gray-300 rounded-full focus:outline-none" />
						<button class="w-6 h-6 ml-1 bg-gray-700 border-2 border-gray-300 rounded-full focus:outline-none" />
						<button class="w-6 h-6 ml-1 bg-red-500 border-2 border-gray-300 rounded-full focus:outline-none" />
					</div>
					<div class="flex items-center ml-6">
						<span class="mr-3">Size</span>
						<div class="relative">
							<select class="py-2 pl-3 pr-10 text-base border border-gray-300 rounded appearance-none focus:outline-none focus:ring-2 focus:ring-green-200 focus:border-green-500">
								<option>SM</option>
								<option>M</option>
								<option>L</option>
								<option>XL</option>
				...
				<div class="flex">
					...
					<button class="flex px-6 py-2 ml-auto text-white bg-green-500 border-0 rounded focus:outline-none hover:bg-green-600">
						Button
					</button>
