...
<template>
  <aside
    v-if="cart"
    class="order-summary bg-white rounded-lg mb-8 w-full min-h-70 p-4 sm:p-8 relative shadow-md  outline-gray-950/10 outline ">
    ...
    <div class="grid gap-1 text-sm font-semibold text-gray-500 ">
      <div class="flex justify-between">
        ...
        <span class="text-gray-800  tabular-nums" v-html="cart.subtotal" />
      </div>
      <div class="flex justify-between">
      ...
      <div class="flex justify-between mt-4 pt-2 border-t border-gray-200 ">
        ...
        <span class="text-xl font-bold text-gray-900  tabular-nums" v-html="cart.total" />
      </div>
    </div>
