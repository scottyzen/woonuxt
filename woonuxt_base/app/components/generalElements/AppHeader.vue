...
<template>
  <header class="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-sm shadow-light-500 dark:shadow-gray-900 border-b border-transparent dark:border-gray-700">
