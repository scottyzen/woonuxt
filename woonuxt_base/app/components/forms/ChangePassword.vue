<template>
  <div>
    ...
    <form class="bg-white rounded-lg shadow-sm border border-gray-100" @submit.prevent="updatePassword">
      ...
      <div class="grid p-6 md:p-8 gap-6 md:grid-cols-2">
        ...
        <div class="w-full space-y-2">
          ...
          <PasswordInput
            ...
            type="text"
            required
            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-gray-50 focus:bg-white" />
        </div>
