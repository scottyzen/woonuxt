<template>
  <div v-if="customer">
    ...
    <form class="bg-white rounded-lg shadow-sm border border-gray-100" @submit.prevent="saveChanges">
      ...
      <div class="grid gap-6 p-6 md:p-8 md:grid-cols-2">
        ...
        <div class="w-full space-y-2">
          ...
          <input
            ...
            type="text"
            disabled
            class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-200 text-gray-600 cursor-not-allowed opacity-60" />
        </div>
