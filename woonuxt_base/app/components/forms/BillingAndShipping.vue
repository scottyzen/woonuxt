<template>
  <form class="bg-white rounded-lg shadow" @submit.prevent="saveChanges">
    <div class="grid p-8 gap-6 md:grid-cols-2">
      ...
      <div class="w-full">
        <label for="billing-company">Company ({{ $t('general.optional') }})</label>
    ...
    <div class="grid p-8 gap-6 md:grid-cols-2">
      <h3 class="font-semibold text-xl col-span-full">{{ $t('general.shipping') }}</h3>
      ...
      <div class="w-full">
        <label for="shipping-company">Company ({{ $t('general.optional') }})</label>
