...
<template>
  <Transition name="fade" mode="out-in">
    ...
    <div v-else class="flex items-center gap-2 mt-4 text-sm text-gray-400 cursor-pointer">
      <!-- Twitter -->
      <a :href="twitterUrl" target="_blank" rel="noopener" title="Share on Twitter">
      ...
      <!-- Facebook -->
      <a :href="facebookUrl" target="_blank" rel="noopener" title="Share on Facebook">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="currentColor">
          <path
      ...
      <!-- Pinterest -->
      <a :href="pinterestUrl" target="_blank" rel="noopener" title="Share on Pinterest">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18" fill="currentColor">
          <path
